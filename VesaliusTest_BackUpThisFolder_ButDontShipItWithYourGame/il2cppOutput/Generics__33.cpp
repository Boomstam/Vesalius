...
IL_0009:
	...
	try
	{
		...
		try
		{
			...
			Dictionary_2_set_Item_mA3A353A85590AFF777A98AF5C9903ECE3803C04D(__this, L_3, ((*(BufferedRpc_t5726D8EEB28B9302694B8149B40624B47355450D*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 18)))), il2cpp_rgctx_method(method->klass->rgctx_data, 54));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
...
IL_0009:
	...
	try
	{
		...
		try
		{
			uint64_t L_3 = V_0;
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_set_Item_mF90D721AC9C32207C15A47B81257D1E5FA368B93(__this, L_3, ((RuntimeObject*)Castclass((RuntimeObject*)L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 18))), il2cpp_rgctx_method(method->klass->rgctx_data, 54));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR RuntimeObject* Dictionary_2_System_Collections_IDictionary_get_Item_m349002DC4143E067C222307A95370CBD610A9BBC_gshared (Dictionary_2_t8E76AA10F849EB48DC945DFABFCC4A6EDA4BAAB6* __this, RuntimeObject* ___0_key, const RuntimeMethod* method) 
{
	int32_t V_0 = 0;
	{
		RuntimeObject* L_0 = ___0_key;
		bool L_1;
		L_1 = Dictionary_2_IsCompatibleKey_mB944CE36F0B60D3E3222EBF84730866AFEBF7393(L_0, il2cpp_rgctx_method(method->klass->rgctx_data, 51));
		if (!L_1)
		{
			goto IL_0030;
		}
	}
	{
		RuntimeObject* L_2 = ___0_key;
		int32_t L_3;
		L_3 = Dictionary_2_FindEntry_m0C1E8801B76A08287AA27DBCCEBAA1D36D9A1FF0(__this, ((*(uint64_t*)UnBox(L_2, il2cpp_rgctx_data(method->klass->rgctx_data, 14)))), il2cpp_rgctx_method(method->klass->rgctx_data, 15));
		V_0 = L_3;
		int32_t L_4 = V_0;
		if ((((int32_t)L_4) < ((int32_t)0)))
		{
...
IL_0009:
	{
		RuntimeObject* L_1 = ___1_value;
		ThrowHelper_IfNullAndNullsAreIllegalThenThrow_TisFontReference_tC622F9633EF0CC4D4A898DB2ACA771122AA722A2_mEA4A3BE7CB0D1857FCB362CEC2481E2663E1A46F(L_1, (int32_t)((int32_t)15), il2cpp_rgctx_method(method->klass->rgctx_data, 53));
	}
	try
	{
		{
		...
		try
		{
			uint64_t L_3 = V_0;
			RuntimeObject* L_4 = ___1_value;
			Dictionary_2_set_Item_m784094E545052294C1C6CBE7238E8C05C3FBC040(__this, L_3, ((*(FontReference_tC622F9633EF0CC4D4A898DB2ACA771122AA722A2*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 18)))), il2cpp_rgctx_method(method->klass->rgctx_data, 54));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
